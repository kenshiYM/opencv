...
ABIs = [
    ABI("2", "armeabi-v7a", "arm-linux-androideabi-4.9", api_level=14, cmake_name="armeabi-v7a with NEON"),
    ABI("1", "armeabi",     "arm-linux-androideabi-4.9", api_level=14),
    ABI("4", "x86",         "x86-4.9", api_level=14),
    ABI("6", "mips",        "mipsel-linux-android-4.9", api_level=14)
]
